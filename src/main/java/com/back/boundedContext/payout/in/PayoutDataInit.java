...
public class PayoutDataInit {
    ...
    private final Job payoutCollectItemsAndCompletePayoutJob;

    public PayoutDataInit(@Lazy PayoutDataInit self, PayoutFacede payoutFacade, JobOperator jobOperator, Job payoutCollectItemsAndCompletePayoutJob) {
        this.self = self;
        this.payoutFacade = payoutFacade;
        this.jobOperator = jobOperator;
        this.payoutCollectItemsAndCompletePayoutJob = payoutCollectItemsAndCompletePayoutJob;
    }
    ...
    public void runCollectItemsAndCompletePayoutBatchJob() {
        ...
        try {
            JobExecution execution = jobOperator.start(payoutCollectItemsAndCompletePayoutJob, jobParameters);
